...
echo '<div class="orders">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                 <h4 class="box-title"> <i class="fa fa-briefcase" aria-hidden="true"></i>Your Job Invites </h4>
                                </div>
                                <div class="card-body--">
...
if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
        $field1name = $row["postname"];
        $field2name = $row["companyname"];
        $field3name = $row["years"];
        ...
        echo '<tr> 
                  ...
                  <td>'.$field5name.'</td> 
                  <td>
                       <a href="apply.php"> <span class="badge badge-complete">APPLY</span></a>
                                                    </td>
              </tr>';
    }
    $result->free();
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <i class="fa fa-briefcase"></i><strong class="card-title pl-2" float="center">Hot Opportunities</strong>
                            </div>
                            <div class="card-body">
                              Associate Engineer
VirtusaPolaris
Bangalore, Chennai, Coimbatore, Hyderabad, Pune, Pondicherry
                                </div>
                                <hr>
                                <div class="card-text text-sm-center">
                                    <a href="online/account.php"><i class="fa fa-"></i>RE-TAKE AMCAT</a>
                                ...
                                <div class="col-lg-6 col-xl-8">
                                    <div class="card bg-flat-color-4  ">
                                        <div class="card-body">
                                            <h4 class="card-title m-0  white-color ">AMCAT SCORE</h4>
                                        </div>
                                         <div class="card-body">
                                              <div class="h4 mb-0">
                                    ...
                                    <div class="progress progress-xs mt-3 mb-0 bg-flat-color-1" style="width: 10%; height: 5px;"></div>
                                </div>
                                </div>
