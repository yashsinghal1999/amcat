					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo_container">
								<a href="#">
									<div class="logo_text">Amc<span>at</span></div>
								</a>
							</div>
							<nav class="main_nav_contaner ml-auto">
								<ul class="main_nav">
									...
									<li><a href="login/student/login.php">Dashboard</a></li>
									<li><a href="login/student/login.php">Login</a></li>
								</ul>
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="login/student/login.php">Dashboard</a></li>
				<li class="menu_mm"><a href="login/student/login.php">Login</a></li>
			</ul>
		</nav>
	</div>
  ...
  overflow-y: scroll;
	...
	<div class="counter_form">
	    	<div class="col fill_height">
						<form class="counter_form_content d-flex flex-column align-items-center justify-content-center" action="newreg.php" method="post">
						
							<div class="counter_form_title">Book Your amcat</div>
							<input type="text" class="counter_input" name="FullName" placeholder="Full Name:" required="required">
							<input type="tel" class="counter_input" name="Email"placeholder="Email:" required="required">
							<input type="tel" class="counter_input" name="MobileNumber" placeholder="Mobile Number:" required="required">
							<input type="tel" class="counter_input" name="Degree"placeholder="Degree:" required="required">
							<input type="tel" class="counter_input" name="YearOfcompletion"placeholder="Year of Completion:" required="required">
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Now Hiring</h2>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_about">
									<div class="footer_logo_container">
										<a href="#">
											<div class="footer_logo_text">Amc<span>at</span></div>
										</a>
									</div>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
									...
									<div class="footer_contact_info">
										<ul>
											<li>Email: Info.sudhanshusaraswat111@gmail.com</li>
											<li>Phone:  +(91) 9557333633</li>
											<li>Agra</li>
										</ul>
									</div>
								</div>
